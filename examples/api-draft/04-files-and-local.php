...
function transferArchive(string $zipPath, string $outputPath, PayloadStoreInterface $payloadStore): void
{
    ...
    try {
        // Lokale Ein-Prozess-Demonstration: zuerst Empfangsvertrag einrichten.
        ...
        // Dieser Aufruf speichert die Datei und sendet anschließend die Referenz.
        ...
        // Höchstens 1 Zustellversuche insgesamt oder 30 s Gesamtbudget; erstes Limit gewinnt.
        // Normale Rückkehr, keine Mindestzahl/Timeout-Exception; Details in 02-programmatic.php.
        $mq->run(maxMessages: 1, maxSeconds: 30);
    } finally {
        $mq->close();
    }
}
